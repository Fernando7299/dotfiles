...
primary_widgets = [
    *workspaces(),
    ...
    widget.CheckUpdates(**base(bg='color4'), update_interval=120, no_update_string='N.A.', distro='Arch'),

    powerline('color3', 'color4'),

    icon(bg="color3", text=' '),  
    
    #widget.NetGraph(**base(bg='color3'), interface='eno1'),
    widget.Net(**base(bg='color3'),interface='eno1', format='{down}↓↑{up}'),
